            ...
            <div class="col-md-3 space logo">
                ...
                <div class="nav flex-column nav-pills pl-1" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="far fa-user-circle pr-2"></i>À Propos</a>
                    ...
                    <a class="nav-link" id="v-pills-travaux-tab" data-toggle="pill" href="#v-pills-travaux" role="tab" aria-controls="v-pills-travaux" aria-selected="false"><i class="far fa-folder-open pr-2"></i>Travaux</a>
                    <a class="nav-link" id="v-pills-contact-tab" data-toggle="pill" href="#v-pills-contact" role="tab" aria-controls="v-pills-contact" aria-selected="false"><i class="far fa-paper-plane pr-2"></i>Contact</a>
                </div>
            </div>