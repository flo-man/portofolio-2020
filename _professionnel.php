<div class="sous-paragraphe">
    <h3>Rendez Vous Records <small>(2013 - <?php echo date('Y'); ?>)</small></h3>
    <p>Activité en micro-entrepreneur</p>
    <ul>
        <li>Gérant de label discographique numérique</li>
    ...
    <div>Apple Carrousel Du Louvre, 75001, Paris, France</div></p>
    <ul>
    ...
    <ul>
        <li>Assistant de clientèle - Rayon Musique Indépendante</li>
    </ul>
</div>