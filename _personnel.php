<div class="sous-paragraphe">
    ...
    <dl class="row">
        <dt class="col-sm-3">Label discographique</dt>
        <dd class="col-sm-9"><a href="http://www.rendezvousrecords.fr" target="_blank">www.rendezvousrecords.fr</a></dd>
    </dl>
    <hr>
    <h3>Podcast</h3>
    ...
    <dl class="row">
        ...
        <dd class="col-sm-8"><a href="http://www.puissancepop.fr" target="_blank">
            <img src="_site_sources/img/pp-art-1.jpg" alt="puissance-pop" class="img-thumbnail w-25">
        </a></dd>
    </dl>
    <hr>
    <h3>Projets Divers</h3>
    <p>J'ai participé à de nombreux autres projets, notamment en qualité d'assistant de production, d'illustrateur, d'organisateur de concert, de spécialiste informatique, etc.</p>
</div>